EXTRACTION_PROMPT = (
    ...
    "}\n\n"
    "Currency rules:\n"
    "- If a currency symbol or code is explicitly present, use it directly like below:\n"
    "   ₦ or 'Naira' → NGN\n"
    "   $ or 'USD' → USD\n"
    "   KSh or 'KES' or 'Kenyan Shillings' → KES\n"
    "- If no symbol is present, infer currency from country/location context:\n"
    "   If the provider name, address, phone code, email domain, or website indicate a specific country, please use their symbol\n"
    "   If the provider/location clearly indicates a specific country, please use their symbol\n"
    "- If no evidence for currency is found, return null.\n"
    "- Do not guess without contextual or location evidence.\n\n"
